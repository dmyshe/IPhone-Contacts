...
enum LocalizeStrings {
    ...
    enum ContactsViewController {
        ...
        static let contactsText = "conctacts_text".localized()
    }
    
    enum ContactsInfoFormViewController {
        static let create = "create_text".localized()

        static let cancel = "cancel_text".localized()
        static let done = "done_text".localized()
        
        static let name = "name_text".localized()
        static let surname = "surname_text".localized()
